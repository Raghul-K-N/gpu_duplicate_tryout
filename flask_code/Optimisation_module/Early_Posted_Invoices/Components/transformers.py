...
class FeatureEngineer(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X):
        ...
        X_ = X.copy()
        X_["EARLY_POSTED_INVOICES"] = np.where((X_['POSTING_DATE'] < X_["INVOICE_DATE"]),1,0)
        ...
        X_['POSTED_QTR'] = X_['POSTING_DATE'].dt.quarter
        X_['POSTED_DAY']=X_['POSTING_DATE'].dt.day
        X_['POSTED_MONTH']=X_['POSTING_DATE'].dt.month
