# Optimization_module/Late_Payment/Componenets/train_model.py
...
from Optimisation_module.Late_Payment.Components.train_pipeline import train_and_save_pipeline
import numpy as np
def main():
    ...
    output_path = output_dir / "opt_early_pymnt_pipeline_v1.pkl"
