# Optimization_module/Unfavorable_Payment_Terms/Componenets/train_model.py
...
from Optimisation_module.Unfavorable_Payment_Terms.Components.train_pipeline import train_and_save_pipeline
import numpy as np
def main():
    ...
    output_path = output_dir / "opt_unfav_pt_pipeline_v1.pkl"
