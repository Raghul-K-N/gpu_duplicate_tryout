# Optimization_module/Suspicious_Keyword/Componenets/train_model.py
...
from Optimisation_module.Suspicious_Keyword.Components.train_pipeline import train_and_save_pipeline
import numpy as np
def main():
    ...
    output_path = output_dir / "opt_early_susp_kew_pipeline_v1.pkl"
