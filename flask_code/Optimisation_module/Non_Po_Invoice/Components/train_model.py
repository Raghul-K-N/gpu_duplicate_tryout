# Optimization_module/Non_Po_Invoice/Componenets/train_model.py
...
from Optimisation_module.Non_Po_Invoice.Components.train_pipeline import train_and_save_pipeline
import numpy as np
def main():
    ...
    output_path = output_dir / "opt_has_po_inv_pipeline_v1.pkl"
