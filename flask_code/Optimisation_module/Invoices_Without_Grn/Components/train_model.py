# Optimization_module/Invoices_Without_Grn/Componenets/train_model.py
...
from Optimisation_module.Invoices_Without_Grn.Components.train_pipeline import train_and_save_pipeline
import numpy as np
def main():
    ...
    output_path = output_dir / "opt_invs_wthout_grn_pipeline_v1.pkl"
