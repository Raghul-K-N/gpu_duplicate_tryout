# Optimization_module/Immediate_Payments/Componenets/train_model.py
...
from Optimisation_module.Immediate_Payments.Components.train_pipeline import train_and_save_pipeline
import numpy as np
def main():
    ...
    output_path = output_dir / "opt_immediate_pay_pipeline_v1.pkl"
