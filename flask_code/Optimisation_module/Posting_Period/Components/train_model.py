# Optimization_module/Posting_Period/Componenets/train_model.py
...
from Optimisation_module.Posting_Period.Components.train_pipeline import train_and_save_pipeline
import numpy as np
def main():
    ...
    output_path = output_dir / "opt_postin_prd_pipeline_v1.pkl"
