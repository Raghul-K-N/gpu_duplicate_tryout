# Optimization_module_GL/Posts_Night/Componenets/train_model.py
...
from Optimisation_module_GL.Posts_Night.Components.train_pipeline import train_and_save_pipeline
import numpy as np
def main():
    ...
    output_path = output_dir / "opt_posts_night_pipeline_v0.pkl"
