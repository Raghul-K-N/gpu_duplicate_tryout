# Optimization_module_GL/Next_Qtr_Posting/Componenets/transformers.py
import pandas as pd
...
class FeatureEngineer(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X):
        ...
        X_['ENTERED_HOUR']=X_['ENTERED_DATE'].dt.hour
        X_['ENTERED_DAY']=X_['ENTERED_DATE'].dt.day
        X_['ENTERED_MONTH']=X_['ENTERED_DATE'].dt.month
        X_['ENTERED_QTR'] = X_['ENTERED_DATE'].dt.quarter
        X_['SAME_QUARTER'] = np.where(X_['POSTED_QTR'] == X_['ENTERED_QTR'], 1, 0)
