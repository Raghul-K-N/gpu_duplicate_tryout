# Optimization_module_GL/Unusual_Account_Pairing/Componenets/train_model.py
...
from Optimisation_module_GL.Unusual_Account_Pairing.Components.train_pipeline import train_and_save_pipeline
import numpy as np
def main():
    ...
    output_path = output_dir / "opt_unusual_account_pairing_pipeline_v0.pkl"
