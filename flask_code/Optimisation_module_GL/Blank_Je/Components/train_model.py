# Optimization_module_GL/Blank_Je/Componenets/train_model.py
...
from Optimisation_module_GL.Blank_Je.Components.train_pipeline import train_and_save_pipeline
import numpy as np
def main():
    ...
    output_path = output_dir / "opt_blank_je_pipeline_v0.pkl"
