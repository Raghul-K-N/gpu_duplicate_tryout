# Parameters/UDC/emeai.py
"""
EMEAI region-specific UDC validation logic
"""
...
def validate_emeai_udc(sap_row: SAPRow, voucher_text: str,
                       gl_accounts_list: Optional[List[str]] = None) -> dict:
    """
    EMEAI-specific UDC validation
    ...
    """
    log_message(f"Validating EMEAI UDC - Company: {sap_row.company_code}")
    ...
    if sap_row.company_code == '921' and sap_row.vendor_code == '1590807':
        ...
        return build_validation_result(
            ...
            highlight=True,
            method='Manual',
            supporting_details={"Summary": "India Vendor-1590807 requires manual review for UDC"}
        )
