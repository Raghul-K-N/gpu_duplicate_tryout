# Schemas/ocr_result_voucher_copy.py
from invoice_verification.constant_field_names import *

class VoucherOCRData:
    """Data class to hold OCR extracted data from voucher request PDF"""
    
    def __init__(self):
        # Initialize voucher-specific fields
    ...
    def from_dict(cls, data: dict):
        """
        Create VoucherOCRData object from JSON dictionary.
        Args:
            data: Dictionary with voucher OCR data (can be empty or None)
        Returns:
            VoucherOCRData object
        """
        obj = cls()
